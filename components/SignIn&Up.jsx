              ...
              { 
                ...
                <div className={styles.BtnDIV}>
                    <button className={styles.BTN+" "+styles.GoogleBTN}>
                        ...
                        />  
                        <span className={styles.GoogleText}>  Sign In With Google Chrome</span>
                    </button>
                </div>
                ...
                <span className={styles.OrText}> 
                    ...
                    <a className={styles.OrText +" "+styles.Link} href={ typePage=="SignIn" ?  "/signUp" :"/signIn"}> Sign { typePage=="SignIn" ?  "up" :" in" } </a> </span>
        </main>
    </> );
}
